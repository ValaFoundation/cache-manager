...
PROJECT_SLUG="cache-manager"
DEPENDENCY_NAME="cache_manager"
REPO_URL="https://github.com/ValaFoundation/cache-manager.git"
REPO_REF="master"
...
[provide]
cache_manager = ${DEPENDENCY_NAME}_deps
EOF
...
echo -e "--------------------------------------------------------"
echo -e "cache_manager_dep = dependency('${DEPENDENCY_NAME}', fallback: ['${PROJECT_SLUG}', 'cache_manager_dep'])"
echo -e ""
echo -e "executable("
echo -e "  'your-binary-name',"
echo -e "  'your-source-files.vala',"
echo -e "  dependencies: [ dependency('glib-2.0'), dependency('gio-2.0'), ${GREEN}cache_manager_dep${NC} ]"
echo -e ")"
echo -e "--------------------------------------------------------"
